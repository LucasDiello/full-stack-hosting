// RecoverPasswordContentModal.js
import { useState } from "react";
import { MdOutlineAttachEmail } from "react-icons/md";
import "./modal.scss"
const RecoverPasswordContentModal = ({ onRequestClose }) => {
...
<div class="popup">
  <form class="form">
    ...
    <div class="note">
      <label class="title-modal">Subscribe for updates</label>
...
on the new hot tech topics.</span>
    ...
    <button onClick={handleRecoverPassword} class="submit">Submit</button>
  </form>
</div>
  );
};

export default RecoverPasswordContentModal;
